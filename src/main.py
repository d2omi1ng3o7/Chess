...
""")
    ...
    #             if self.board[position] == '  ':                                                          # przerób to na szukanie attached fields
    #                 continue
                
    #             match piece:
    #                 case 'K': listMoves = king(self.board, position, color)
